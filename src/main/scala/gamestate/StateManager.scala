...
//                webSocketHub.broadcast(DrawCard(card, playerID.some)) *> commandQueue.offer(
//                  Envelope(TryDefuse(playerID), none).some
//                )
//              case _ => webSocketHub.sendToPlayer2(playerID)(DrawCard(card, none))
//            }
//
...
////                  ),
////                  webSocketHub.broadcast(PlayCard(card, playerID))
////                )
////
